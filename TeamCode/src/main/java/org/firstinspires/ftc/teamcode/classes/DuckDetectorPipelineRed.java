...
@Config
public class DuckDetectorPipelineRed {
    OpenCvCamera webcam;
    Threshold thresh;
    ...
    public DuckDetectorPipelineRed(HardwareMap hardwareMap, String camName){
...
//            }
            ...
            Imgproc.rectangle(threshold, new Point(60,0),new Point(middleX,240),new Scalar(255,0,0), 2);
...
//            }
            ...
            Mat section1 = threshold.submat(new Rect(new Point(60,0), new Point(middleX,240)));
...
//            }
            ...
            if(Math.abs(avg1 - avg2) >= 3) {
                if (avg1 > avg2) {
                    position = DuckPos.LEFT;
                    Imgproc.rectangle(threshold, new Point(60, 0), new Point(middleX, 240), new Scalar(255, 0, 0), -1);
                } else {
                    position = DuckPos.CENTER;
            ...
            switch (stage){
                case 0:
                    ...
                    Imgproc.line(ycrcb, new Point(middleX, 0), new Point(middleX, 240), new Scalar(255,0,0), 2);
                    return ycrcb;
                case 1:
                    telemetry = "active stage is coi" + "\navg 1: " + avg1 + "\navg 2: " + avg2;
                    Imgproc.line(coi2, new Point(middleX, 0), new Point(middleX, 240), new Scalar(255,0,0), 2);
                    return coi2;
                case 2:
                ...
                case 3:
                    ...
                    Imgproc.line(input, new Point(middleX, 0), new Point(middleX, 240), new Scalar(255,0,0), 2);
                    return input;
                default:
                    telemetry = "active stage is input" + "\navg 1: " + avg1 + "\navg 2: " + avg2;
                    Imgproc.line(input, new Point(middleX, 0), new Point(middleX, 240), new Scalar(255,0,0), 2);
