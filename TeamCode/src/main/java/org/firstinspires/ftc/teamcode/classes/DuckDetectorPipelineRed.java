...
public class DuckDetectorPipelineRed {
    ...
    DuckPos position;
    public static Rect middle = new Rect(205,100,25,25);
    public static Rect left = new Rect(70,110,25,25);
...
//            }
            ...
            Imgproc.rectangle(threshold, left,new Scalar(255,0,0), 2);
...
//            }
            ...
            Mat section1 = threshold.submat(left);
...
//            }
            ...
            if(Math.abs(avg1 - avg2) >= filterVal) {
                if (avg1 > avg2) {
                    ...
                    Imgproc.rectangle(threshold, left, new Scalar(255, 0, 0), -1);
                } else {
            ...
            switch (stage){
                case 0:
                    ...
                    Imgproc.rectangle(ycrcb, left,new Scalar(255,0,0), 2);
                    Imgproc.rectangle(ycrcb, middle,new Scalar(255,0,0), 2);
                    return ycrcb;
                case 1:
                    telemetry = "active stage is coi" + "\navg 1: " + avg1 + "\navg 2: " + avg2;
                    Imgproc.rectangle(coi2, left,new Scalar(255,0,0), 2);
